...
<div class="container">
    ...
    <table>
        <thead>
        <tr>
            <th>ID</th><th>Full Name</th><th>Contact</th><th>Address</th><th>Email</th><th>Actions</th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <a href="customers.php?action=delete&id=<?= $row['customer_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this customer?')">Delete</a>
            </td>
        </tr>
        <?php endwhile; ?>
        </tbody>
